...
import Document from './DocumentAcceptedContainer';
...
class DocumentsAcceptedComponent extends Component {
    render() {
              ...
              <Table className={classes.table}>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>Patvirtinimo data</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
...
DocumentsAcceptedComponent.propTypes = {
  documents: PropTypes.array.isRequired
};
export default withStyles(styles)(DocumentsAcceptedComponent);

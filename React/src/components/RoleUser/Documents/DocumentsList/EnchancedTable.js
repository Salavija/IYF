...
let counter = 0;
function createData(document_id, title, type, describtion) {
  counter += 1;
  return { id: counter, document_id, title, type, describtion };
}
...
// ID, Autorius, pavadinimas, tipas, aprašymas, adresatas
// document_id, author, title, type, describtion, addressee
